...
<head>
    ...
    <style>
        ...
        /* Two-column layout — sidebar renders inline below main content on
           mobile (it already sits right after .fd-main in the HTML), and
           becomes a sticky side column at the wider breakpoint. */
        .fd-layout  { display:block; }
        .fd-sidebar { display:flex; flex-direction:column; gap:20px; margin-top:24px; }
        @media(min-width:900px){
            .fd-layout  { display:grid; grid-template-columns:1fr 280px; gap:28px; align-items:start; }
            .fd-sidebar { position:sticky; top:16px; margin-top:0; }
        }
