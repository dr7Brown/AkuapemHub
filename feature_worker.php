...
<body class="has-bottom-nav">
    <header class="app-topbar">
        ...
        <span class="brand">Feature my profile</span>
    </header>
            ...
            <?php else: ?>
                <?php if (!$isPaid): ?>
                    ...
                    <form method="post" action="feature_worker.php">
                        <button type="submit" class="button button-primary">Feature my profile</button>
                    </form>
                <?php else: ?>
                    <h2 style="margin-top:0;">Choose a promotion package</h2>
