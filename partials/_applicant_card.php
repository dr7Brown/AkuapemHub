<?php
/**
 * Partial: applicant card for job_applications.php
...
$statusInfo = $statusLabels[$appStatus] ?? ['label' => ucfirst($appStatus), 'class' => ''];
    ...
    <div class="applicant-head">
        <div style="flex:1;min-width:0;">
            ...
            <?php if (!empty($app['bio'])): ?>
                <p style="font-size:0.83rem;color:var(--text-muted);margin:4px 0 0;"><?php echo sanitize(mb_substr($app['bio'], 0, 120)); ?><?php echo mb_strlen($app['bio']) > 120 ? '…' : ''; ?></p>
            <?php endif; ?>
        </div>
